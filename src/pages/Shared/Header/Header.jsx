      ...
      <nav className="flex-center max-w-[1280px] mx-auto">
        <div className="text-xl md:text-3xl font-bold flex items-center gap-2">
          ...
          <h1 className="primary-text-color">
            Kid<span className="secondary-text-color">zy</span> School
          </h1>
        </div>
        ...
        <ul
          className={
            isOpenMenu
              ? "absolute top-14 bg-slate-200 p-5 right-10 items-start flex flex-col gap-2 font-semibold rounded z-10"
              : "w-fit gap-5 lg:gap-8 text-base font-semibold hidden lg:flex justify-between items-center"
          }
        >
          <NavLink
            to="/"
          ...
          {userLevel && userLevel[0]?.level === "student" && (
            <NavLink
              to="/activity"
              className={({ isActive }) => (isActive ? "isActive" : "")}
            >
          ...
          {userLevel && userLevel[0]?.level === "student" && (
            <>
              ...
              <NavLink
                ...
                className={({ isActive }) => (isActive ? "isActive" : "")}
              >
                <div className="relative" title="Enrolled course">
              ...
              <NavLink
                ...
                className={({ isActive }) => (isActive ? "isActive" : "")}
              >
                <div className="relative" title="Bookmarked course">
                  <span className="badge">0</span>
                  <BookmarkIcon className="w-5 h-5 "></BookmarkIcon>
                </div>
              </NavLink>
            </>
          )}
            ...
            <>
              ...
              >
                <div className="relative">
                  <span className="absolute -top-[4px] -right-3 px-1 text-center text-sm">
                    0
                  </span>
                  <p>Inbox</p>
                </div>
          ...
          <div className="flex gap-3 lg:ml-7 items-center relative">
            {user && (
              <div title={user.displayName}>
                {user.photoURL !== "" ? (
                  ...
                  <FaUserCircle className="w-7 h-7"></FaUserCircle>
                )}
              </div>
            )}
            {!user ? (
            ...
            <div
              onClick={showProfile}
              className={`min-w-[250px] h-fit absolute z-10 rounded-md shadow-md hover:shadow-2xl bg-slate-700 py-8 px-5 ${
                openProfile ? "top-12 right-7 " : "hidden"
              } `}
            >
              ...
              <div className="text-center  mt-5 ">
                ...
                <div
                  className="mt-4 px-3 py-1 rounded-full hover:bg-white hover:text-[#E25111]  hover:scale-[0.98] duration-200 origin-center bg-[#E25111] text-white w-1/2 mx-auto"
